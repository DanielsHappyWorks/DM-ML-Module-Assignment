...
{
  png(paste("diagrams/regression/wine_", xLable, "_vs_", yLable, "_scatter.png", sep = "", collapse = NULL), width = 500, height = 500)
  ...
  dev.off()
  png(paste("diagrams/regression/wine_", xLable, "_hist.png", sep = "", collapse = NULL), width = 500, height = 500)
